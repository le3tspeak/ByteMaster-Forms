...
namespace Game_Server_Manager.Forms
{
    public partial class FormSteamCMD : Form
    {
        ...
        private readonly string SteamCMDPath = Path.Combine(Properties.Settings.Default.SteamCMDPath, "steamcmd.exe");
        private readonly string LogFilePath = Path.Combine(Properties.Settings.Default.SteamCMDPath, "logs", "bootstrap_log.txt");
